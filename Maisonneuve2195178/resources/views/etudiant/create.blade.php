                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="control-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control mb-2" placeholder="name@example.com">
                            </div>
                            <div class="control-group">
                                <label for="date_naissance">Date De Naissance</label>
                                <input type="text" name="date_naissance" id="date_naissance" class="form-control mb-2" placeholder="YYYY-MM-DD">
                            </div>
                            <div class="control-group">
